            ...
            try:
                ...
                if curr_status != 200:
                    ...
                    if fail_count[site] == alert_threshold and last_status[site] == 200:
                        ...
                        send_tg_msg(f"🚨 DOWN: {site} (Error {curr_status})", shot_path)
...
async def index(auth: bool = Depends(check_auth)):
    ...
    <style>
        ...
        .btn-test {{ background: #00717a; color: white; border: none; padding: 8px 16px; border-radius: 6px; cursor: pointer; }}
    ...
    <div class="container">
        <h1>📊 Sibur Monitoring <span style="font-size:14px; color:#94a3b8; font-weight:normal;">{now_msk}</span></h1>
        <div class="kpi-grid">
